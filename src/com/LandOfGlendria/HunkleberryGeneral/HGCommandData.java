...
public enum HGCommandData {
	...
	SET_COMPASS				("setcompass",		"hg.spawn",				true,	"",	true,	"[playername] [x y z] [here]:default=current world spawn",				"Sets your compass to point to the desired location, [here] indicates the literal string 'here'."),
	...
	WRITE_COMMAND_HTML		("writehtml",		"hg.commands.change",	true,	"",	true,	"(no arguments)",														"Write the current command configuration to " + HGStatics.COMMAND_HTML_FILE),
