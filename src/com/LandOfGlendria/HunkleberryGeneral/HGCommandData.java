...
public enum HGCommandData {
	...
	FORCE_BOUNCE			("forcebounce",		"hg.bounce",			true,	"",	true,	"{player|ip}",															"Since ince the other bounces require the bouncee to be online for name/ip validation and actual kikking this command is provided to allow ofline name/IPs to be bounced without validation. IPs must be formatted as /x.x.x.x. No attempt is made to ban a currently onlin player."),
