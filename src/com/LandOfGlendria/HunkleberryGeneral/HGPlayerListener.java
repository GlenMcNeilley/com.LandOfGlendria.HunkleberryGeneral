...
public class HGPlayerListener extends PlayerListener
{
	...
	public void onPlayerCommand(PlayerChatEvent event)
	{
		...
		{
			msg.sendPositiveMessage(player, (new StringBuilder(String.valueOf(HunkleberryGeneral.pdfFile.getName()))).append(" version ").append(HunkleberryGeneral.pdfFile.getVersion()).append(" is listening.").toString());
		...
		{
			log.warning((new StringBuilder(String.valueOf(HunkleberryGeneral.pdfFile.getName()))).append(": /").append(base).append(" Another plugin is using this command.").toString());
			return;
		} else
		{
			event.setCancelled(true);
